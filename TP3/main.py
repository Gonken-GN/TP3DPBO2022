...
def inputs():
    ...
    hobiCombo['values'] = ('Gaming', 'Ngelawak', 'Jalan-Jalan', 'Ngewibu')
    hobiCombo.current(2)
...
def galery():
    ...
    dframe.pack(padx=10, pady=10)
    my_img1 = ImageTk.PhotoImage(Image.open('image/gambar3.jpg'))
    my_img2 = ImageTk.PhotoImage(Image.open('image/gambar2.jpg'))
    my_img3 = ImageTk.PhotoImage(Image.open('image/gambar4.jpg'))
    my_img4 = ImageTk.PhotoImage(Image.open('image/gambar1.jpg'))
